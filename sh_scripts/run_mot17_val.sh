...
if [ $# -ne 0 ]; then
    ...
    python tools/run_mot.py --alg_name $1 -f exps/example/mot/yolox_x_mot17_half.py \
        -c pretrained/ocsort_x_mot17.pth.tar -b 1 -d 1 --fp16 --fuse --expn $1  --use_saved_dets
    exit 1
fi

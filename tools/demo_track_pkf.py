...
def image_demo(predictor, vis_folder, current_time, args):
    if osp.isdir(args.path):
        ...
        files = [args.path]
    files.sort()
    tracker = PKFTracker(det_thresh=args.track_thresh, iou_threshold=args.iou_thresh,
                         asso_func=args.asso, delta_t=args.deltat, inertia=args.inertia,
                         use_ocr=args.use_ocr, use_ocm=args.use_ocm, 
                         ambig_thresh=args.ambig_thresh, update_weight_thresh=args.update_weight_thresh)
    timer = Timer()
    results = []

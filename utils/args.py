...
def make_parser():
    parser = argparse.ArgumentParser("PKF parameters")

    parser.add_argument("--alg_name", type=str, default="pkf", help="algorithm name")
    parser.add_argument("--expn", type=str, default=None)
    parser.add_argument("-n", "--name", type=str, default=None, help="model name")

    # distributed
    parser.add_argument( "--dist-backend", default="nccl", type=str, help="distributed backend")
    parser.add_argument("--output_dir", type=str, default="YOLOX_outputs/mot")
    # parser.add_argument("--dataset_root", type=str, default="/home/hanwen/shared/data/tracking_datasets")
    parser.add_argument("--detection_dir", type=str, default="YOLOX_outputs/mot/detections")
    parser.add_argument("--save_detections", action='store_true')   # the default is False
    parser.add_argument("--use_saved_dets", action='store_true')    # the default is False
    ...
    parser.add_argument("--use_ocm", dest="use_ocm", default=False, action="store_true", 
                        help="Using Observation-Centric Momentum (OCM) introduced in OC-SORT.")
    parser.add_argument("--use_ocr", dest="use_ocr", default=False, action="store_true", 
                        help="Using Observation-Centric Recovery (OCR) introduced in OC-SORT.")
    parser.add_argument("--ambig_thresh", default=0.9, type=float, help="ambiguity check threshold")
    parser.add_argument("--update_weight_thresh", default=0.3, type=float, help="The least weight of an associated bbox to update the track.")
    parser.add_argument("--score_thresh", default=1.0, type=float, help="score threshold")
    parser.add_argument("--skip_thresh", default=0.95, type=float, help="skip threshold")
    parser.add_argument("--coef", default=2.0, type=float, help="1/IoU coefficient in distance")
    parser.add_argument("--test", dest="test", default=False, action="store_true", help="Evaluating on test-dev set.",)
    parser.add_argument("--train", dest="train", default=False, action="store_true", help="Evaluating on train-dev set.",)
